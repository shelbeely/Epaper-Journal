#pragma once
// ─────────────────────────────────────────────────────────────────────────────
// Font5x7.h — Classic 5×7 bitmap font, ASCII 0x20–0x7E (95 printable chars)
//
// Encoding: FONT5X7[char - 0x20] = 5 column bytes.
//   Each byte represents one column; bit 0 = top pixel row, bit 6 = bottom row.
